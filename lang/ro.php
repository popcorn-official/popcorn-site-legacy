...
$langsite = Array(
    ...
    "TITLE_DESC"             => "Priveşte filme de pe torrente instantaneu",
    "SITE_DESC"              => "Nu mai descărca filme! Priveşte cele mai bune filme instantaneu in HD, cu subtitrari, gratuit! Disponibil pentru Windows, Mac şi Linux.",
    ...
    "FEAT_NORESTRICTION_DESC"=> "Priveşte orice filme doreşti de cate ori doreşti. Singurul lucru de care ai nevoie este o conexiune la internet.",
    "FEAT_CATALOGUE"         => "Colecţie de filme variată", 
    "FEAT_CATALOGUE_DESC"    => "Daca filmul se afla pe internet Popcorn Time va găsi cea mai bună versiune posibilă si va începe sa ruleze filmul instantaneu.",
    ...
    "HOW_DESC"               => "Vezi cat de uşor funcţionează...",
